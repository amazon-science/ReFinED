...
from doc_preprocessing.dataclasses import BatchElement, BatchElementToken
...
def mask_mentions(
    ...
    """
    Masks entity mentions in the batch element a random percentage of the time with the [MASK] token and some times
