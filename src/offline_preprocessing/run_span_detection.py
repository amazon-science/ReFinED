...
from refined.standalone_md import MentionDetector
from dataset_reading.mention_detection.conll_reader import CoNLLNER, CONLL_NER_TAG_TO_NUM
...
def add_spans(aligned_wiki_file: str, output_dir: str, device: str, start_line: int, end_line: int, model_dir: str,
    ...
    output_filename = f'{output_dir}/wikipedia_links_aligned.json_spans.json' if part_num is None \
        else f'{output_dir}/wikipedia_links_aligned.json_spans_{part_num}.json'
