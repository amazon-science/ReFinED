...
from utilities.general_utils import get_huggingface_config, get_huggingface_model, get_tokenizer
...
class DescriptionEncoder(nn.Module):
    def __init__(
        ...
        config = get_huggingface_config(transformer_name=transformer_name, data_dir=data_dir)
        ...
        self.tokenizer = get_tokenizer(
            ...
            # TODO: check if special tokens should be added here add_special_tokens use default
        )
